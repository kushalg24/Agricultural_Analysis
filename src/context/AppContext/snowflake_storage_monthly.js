...
function SnowflakeStorageConsumption_mom({ size }) {
  const [graphType, setGraphType] = useState("line"); // Default graph type is line

  // Static data representing month-over-month Snowflake Storage Consumption for different services
  const months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
  const dummyData = {
    months: months,
    services: [
      { name: "Compute", data: [30, 320, 30, 330, 30, 300, 300, 400, 400, 400, 400, 490] },
      { name: "Storage", data: [200, 210, 200, 20, 200, 20, 260, 270, 20, 200, 300, 310] },
      { name: "Data Transfer", data: [100, 110, 100, 130, 100, 100, 160, 100, 100, 190, 200, 210] },
      { name: "Services", data: [50, 60, 70, 80, 90, 100, 110, 120, 130, 140, 150, 160] },
      { name: "Other", data: [30, 40, 50, 60, 70, 80, 90, 100, 110, 120, 130, 140] },
    ]
  };
  ...
  const insight = "Storage consumption shows significant spikes in some months.";
  const cta = "Analyze the spikes and optimize storage usage to prevent cost overruns.";
...
export default SnowflakeStorageConsumption_mom;
